import { ModuleOptions, FunctionOptions } from './options';

/**
 * Converts passed strings/objects into valid class name.
 *
 * @param   {string|null}   el
 *   The name of the element, can be omitted (or `null`) if you need to interact with the modifiers and mixins of the block itself.
 *   @default null
 *   @example
 ...
 *   List of mixins (if passed string) and modifiers (if passed object). \
 *   @example
 *     const b = bemClassNames()('block');
 ...
 */
declare function BemFn(el?: string|null, ...args: (string|object)[]): string;
...
export { ModuleOptions, FunctionOptions }
